...
public class TaschenrechnerOperator1 {
	 ...
	 * @return String summe
	 */
	public String getSum(String aufgabe) {
	...
	private String ausklammern(String aufgabe){
	...
	//Berechnet linke mit rechter Zahl und f�gt Summe in Aufgabe ein 
